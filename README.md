...
- Shareable household invitation links with a direct `/invite/{token}` acceptance screen.
...
- Standalone dashboard, accounts, account details/reconciliation, categories, receipts, reports, notifications, offline sync, transaction history, settings, and security screens.
